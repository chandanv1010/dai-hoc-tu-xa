            ...
            <div class="uk-flex uk-flex-middle uk-flex-space-between">
                ...
                <div class="header-top-right">
                    <div class="contact-info">
                        <a href="tel:{{ $system['contact_phone'] ?? '01234567899' }}" class="phone-link">
                            <i class="fa fa-phone"></i>
                            <span>{{ $system['contact_phone'] ?? '01234567899' }}</span>
                        </a>
                ...
                <div class="tool">
                    <div class="menu-link">
                        <a href="#mobileCanvas" class="mobile-menu-button" data-uk-offcanvas="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" fill="currentColor" viewBox="0 0 448 512" class="w-6 h-6 cursor-pointer box-content">
