@php
    // Lấy system data trực tiếp
    $language = 1; // Default language
    $system = convert_array(\App\Models\System::where('language_id', $language)->get(), 'keyword', 'content');
    
    // SEO data cho trang 404
    $seo = [
        ...
        'follow' => 0, // nofollow cho trang 404
    ];
